...
//     });
//     const pr = Thoughts.create(updatedThoughts);
//     return pr;
//   })
//   .then(createdThoughts => {
//     console.log("thoughts have been created", createdThoughts.length);
//     const updateUserPromises = createdThoughts.map(thought => {
//       const userId = thought.userId;
//       return User.findByIdAndUpdate(userId, { $push: { myThoughts: thought._id } });
//     });
